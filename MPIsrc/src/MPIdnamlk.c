...
{  /* DNA Maximum Likelihood with molecular clock */
  ...
  MPICopyWholeFile("stdin", "stdin file", "MPIdnamlk");             /*-MPI-*/
  MPI_Barrier(MPI_COMM_WORLD);                                      /*-MPI-*/
 
  MPIOpenStdinFile(stdin,"stdin","stdin file","r", "MPIdnamlk",     /*-MPI-*/
              stdinfilename);                                       /*-MPI-*/
  MPI_Barrier(MPI_COMM_WORLD);                                      /*-MPI-*/
  /***************************************************************** *-MPI-*/
  init(argc,argv);
  ...
  if ( ctgry ) {
    MPICopyWholeFile(CATFILE, "categories file", "MPIdnamlk");     /*-MPI-*/
    MPI_Barrier(MPI_COMM_WORLD);                                     /*-MPI-*/
  ...
  if ( weights || justwts ) {
    MPICopyWholeFile(WEIGHTFILE, "weights file", "MPIdnamlk");     /*-MPI-*/
    MPI_Barrier(MPI_COMM_WORLD);                                     /*-MPI-*/
